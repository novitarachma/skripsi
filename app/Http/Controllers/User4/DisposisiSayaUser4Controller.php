...
namespace App\Http\Controllers\User4;
...
class DisposisiSayaUser4Controller extends Controller
{
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $actionBtn = '
                            <center>
                            <a href="disposisi-sayauser4/detail?kode=' . $row->id . '" class="btn btn-outline-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Detail Surat"><i class="ti-search"> Detail</i></a>
        ...
        return view('user4.disposisisaya.index', [
    ...
    function detail_surat(Request $request)
    {
        ...
        return view('user4.disposisisaya.detail', [
            'title' => 'Disposisi Surat',
            'surat' => $surat
        ]);
    }
