...
class HistoriSuratKeluarAdmin2Controller extends Controller
{
    public function index()
    {
        //datatable
        if (request()->ajax()) {
            $data = SuratKeluar::whereIn('status', ['diverifikasi-sekdin', 'selesai', 'ditolak'])
            ->get();
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $actionBtn = '
                            <center>
                            <a href="histori-suratkeluaradmin2/detail?kode=' . $row->id . '" class="btn btn-outline-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Detail Surat"><i class="ti-search"> Detail</i></a>
                            </center>';
                    return $actionBtn;
                })
        ...
        return view('admin2.historisuratkeluar.index', [
    ...
    function detail_surat(Request $request)
    {
        ...
        return view('admin2.historisuratkeluar.detail', [
