...
class SuratMasukUser11Controller extends Controller
{
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $actionBtn = '
                            <center>
                            <a href="surat-masukuser11/detail?kode=' . $row->id . '" class="btn btn-outline-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Detail Surat"><i class="ti-search"></i></a>
                            </center>';
                    return $actionBtn;
                })
        ...
        return view('user11.historisurat.index', [
            'title'     => 'Surat Masuk',
            'jabatan'   => $jabatan,
            'karyawan'  => $karyawan
        ]);
    ...
    function detail_surat(Request $request)
    {
        ...
        return view('user11.historisurat.detail', [
