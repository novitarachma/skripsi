...
class DisposisiSayaUser5Controller extends Controller
{
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    $actionBtn = '
                            <center>
                            <a href="disposisi-sayauser5/detail?kode=' . $row->id . '" class="btn btn-outline-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Detail Surat"><i class="ti-search"> Detail</i></a>
        ...
        return view('user5.disposisisaya.index', [
    ...
    function detail_surat(Request $request)
    {
        ...
        return view('user5.disposisisaya.detail', [
            'title' => 'Disposisi Surat',
            'surat' => $surat
        ]);
    }
