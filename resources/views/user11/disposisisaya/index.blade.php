...
@include('user11.disposisisaya.modal')
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dataTable').DataTable({
            ...
            ajax: {
                  url: '{{ route('user11.disposisisayauser11.index')}}',
                  type: "GET",
            },
            columns: [
    ...
    function save(){
        ...
        $('#catatan_kadin').html("");
        $.ajax({
            url : "{{ route('user11.disposisisayauser11.store')}}",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "JSON",
    ...
    function edit(id){
        ...
        $.ajax({
            url : "/user11/disposisisayauser11/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                $('[name="id"]').val(data.id);
