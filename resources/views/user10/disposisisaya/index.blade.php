...
@include('user10.disposisisaya.modal')
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dataTable').DataTable({
            ...
            ajax: {
                  url: '{{ route('user10.disposisisayauser10.index')}}',
                  type: "GET",
            },
            columns: [
    ...
    function save(){
        ...
        $('#catatan_kadin').html("");
        $.ajax({
            url : "{{ route('user10.disposisisayauser10.store')}}",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "JSON",
    ...
    function edit(id){
        ...
        $.ajax({
            url : "/user10/disposisisayauser10/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                $('[name="id"]').val(data.id);
