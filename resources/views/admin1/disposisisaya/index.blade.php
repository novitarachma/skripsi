...
@include('admin1.disposisisaya.modal')
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dataTable').DataTable({
            ...
            ajax: {
                  url: '{{ route('admin1.disposisisayaadmin1.index')}}',
                  type: "GET",
            },
            columns: [
    ...
    function save(){
        ...
        $('#catatan_kadin').html("");
        $.ajax({
            url : "{{ route('admin1.disposisisayaadmin1.store')}}",
            type: "POST",
            data: $('#form').serialize(),
            dataType: "JSON",
    ...
    function edit(id){
        ...
        $.ajax({
            url : "/admin1/disposisisayaadmin1/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                $('[name="id"]').val(data.id);
