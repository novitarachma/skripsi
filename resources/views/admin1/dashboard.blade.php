                        ...
                        <div class="col-md-6 mt-5 mb-3">
                            <div class="card">
                                <div class="seo-fact sbg1">
                                    ...
                                    <a href="{{ url('admin1/suratmasukadmin1') }}" class="btn btn-primary"
                        ...
                        <div class="col-md-6 mb-3 mb-lg-0">
                            <div class="card">
                                <div class="seo-fact sbg3">
                                    ...
                                    <a href="{{ url('admin1/disposisisayaadmin1') }}" class="btn btn-primary"
                                    style="background-color: #edf1f1; border-color: #edf1f1; color: black; border-radius: 5px; margin-left: 10px; margin-bottom: 10px; margin-top: 10px; width: 120px;"
                                    >Lihat Detail   <i class="ti-arrow-circle-right"></i></a>
                                    <canvas id="seolinechart1" height="50"></canvas>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="seo-fact sbg4">
                                    ...
                                    <a href="{{ url('admin1/historisuratadmin1') }}" class="btn btn-primary"
                                    style="background-color: #edf1f1; border-color: #edf1f1; color: black; border-radius: 5px; margin-left: 10px; margin-bottom: 10px; margin-top: 10px; width: 120px;"
                                    >Lihat Detail   <i class="ti-arrow-circle-right"></i></a>
                                    <canvas id="seolinechart2" height="50"></canvas>
                                </div>
